...
const WCAG_CRITERIA: WcagCriterion[] = [
  // --- 1. 知覚可能 (Perceivable) ---
  {
    ...
    category: "知覚可能",
    level: "A",
    description: 'img要素のalt属性の有無、alt値が適切か、装飾画像にalt=""が設定されているか',
    axeTags: ["wcag111"],
  },
  {
    id: "1.2.1",
    ...
    category: "知覚可能",
    level: "A",
    description: "音声のみ/映像のみのコンテンツに代替テキストまたは代替メディアが提供されているか",
    axeTags: ["wcag121"],
  },
  {
    id: "1.2.2",
  ...
  },
  {
    ...
    category: "知覚可能",
    level: "A",
    description: "映像コンテンツに音声解説またはテキストによる代替が提供されているか",
    axeTags: ["wcag123"],
  },
  {
    id: "1.2.4",
  ...
  },
  {
    ...
    category: "知覚可能",
    level: "A",
    description: "見出し構造（h1-h6）の妥当性、フォーム要素のラベル紐付け、テーブルのth/caption",
    axeTags: ["wcag131"],
  },
  {
    id: "1.3.2",
  ...
  },
  {
    ...
    category: "知覚可能",
    level: "A",
    description: "色・形・位置のみで情報を伝えていないか（例：「赤いボタンを押してください」）",
    axeTags: ["wcag133"],
  },
  {
    id: "1.3.4",
    ...
    category: "知覚可能",
    level: "AA",
    description: "コンテンツが縦向き・横向きの両方で閲覧可能か。特定の向きに固定されていないか",
    axeTags: ["wcag134"],
  },
  {
    id: "1.3.5",
    ...
    category: "知覚可能",
    level: "AA",
    description: "フォーム要素に適切なautocomplete属性が設定されているか",
    axeTags: ["wcag135"],
  },
  {
    id: "1.4.1",
  ...
  },
  {
    ...
    category: "知覚可能",
    level: "A",
    description: "自動再生される音声が3秒以上の場合、一時停止/停止/音量調整の手段があるか",
    axeTags: ["wcag142"],
  },
  {
    id: "1.4.3",
    ...
    category: "知覚可能",
    level: "AA",
    description: "テキストと背景のコントラスト比が4.5:1以上（大文字テキストは3:1以上）",
    axeTags: ["wcag143"],
  },
  {
    id: "1.4.4",
    ...
    category: "知覚可能",
    level: "AA",
    description: "テキストを200%まで拡大しても、コンテンツや機能が損なわれないか",
    axeTags: ["wcag144"],
  },
  {
    id: "1.4.5",
    ...
    category: "知覚可能",
    level: "AA",
    description: "テキストの代わりに画像化された文字を使用していないか（ロゴ等の例外を除く）",
    axeTags: ["wcag145"],
  },
  {
    id: "1.4.10",
    ...
    category: "知覚可能",
    level: "AA",
    description: "幅320px（400%ズーム）まで縮小しても横スクロールなしでコンテンツが閲覧可能か",
    axeTags: ["wcag1410"],
  },
  {
    id: "1.4.11",
    ...
    category: "知覚可能",
    level: "AA",
    description: "UIコンポーネントやグラフィックのコントラスト比が3:1以上か",
    axeTags: ["wcag1411"],
  },
  {
    id: "1.4.12",
  ...
  },
  {
    ...
    category: "操作可能",
    level: "A",
    description: "キーボード操作でフォーカスが特定の要素に閉じ込められないか",
    axeTags: ["wcag212"],
  },
  {
    id: "2.1.4",
  ...
  },
  {
    ...
    category: "操作可能",
    level: "A",
    description: "制限時間のあるコンテンツで、延長/解除/事前通知の手段があるか",
    axeTags: ["wcag221"],
  },
  {
    id: "2.2.2",
    ...
    category: "操作可能",
    level: "A",
    description: "自動的に動く/スクロールする/点滅するコンテンツに一時停止/停止の手段があるか",
    axeTags: ["wcag222"],
  },
  {
    id: "2.3.1",
  ...
  },
  {
    ...
    category: "操作可能",
    level: "A",
    description: "ページ上部にスキップリンク、またはランドマーク（main, nav等）が設定されているか",
    axeTags: ["wcag241"],
  },
  {
    id: "2.4.2",
    ...
    category: "操作可能",
    level: "A",
    description: "title要素が存在し、ページ内容を適切に説明しているか",
    axeTags: ["wcag242"],
  },
  {
    id: "2.4.3",
    ...
    category: "操作可能",
    level: "A",
    description: "Tabキーでのフォーカス移動順序が論理的で意味のある順序になっているか",
    axeTags: ["wcag243"],
  },
  {
    id: "2.4.4",
    ...
    category: "操作可能",
    level: "A",
    description: "リンクテキストが単体またはコンテキスト内でリンク先を理解できるか",
    axeTags: ["wcag244"],
  },
  {
    id: "2.4.5",
    ...
    category: "操作可能",
    level: "AA",
    description: "ページへの到達手段が2つ以上あるか（ナビゲーション、サイトマップ、検索等）",
    axeTags: ["wcag245"],
  },
  {
    id: "2.4.6",
  ...
  },
  {
    ...
    category: "操作可能",
    level: "AA",
    description: "フォーカスされた要素がposition:fixed/sticky等の要素で完全に隠れないか",
    axeTags: ["wcag2411"],
  },
  {
    id: "2.5.1",
  ...
  },
  {
    ...
    category: "操作可能",
    level: "A",
    description: "mousedown/touchstartだけで機能が実行されず、キャンセル手段があるか",
    axeTags: ["wcag252"],
  },
  {
    id: "2.5.3",
    ...
    category: "操作可能",
    level: "A",
    description: "視覚的なラベルがアクセシブルネーム（aria-label等）に含まれているか",
    axeTags: ["wcag253"],
  },
  {
    id: "2.5.4",
    ...
    category: "操作可能",
    level: "A",
    description: "デバイスの動き（振る、傾ける等）で起動する機能に、UIによる代替手段があるか",
    axeTags: ["wcag254"],
  },

  {
    ...
    category: "操作可能",
    level: "AA",
    description: "ドラッグ操作が必要な機能に、単一ポインタの代替手段があるか",
    axeTags: ["wcag257"],
  },
  {
    id: "2.5.8",
    ...
    category: "操作可能",
    level: "AA",
    description: "操作要素のターゲットサイズが最低24x24pxあるか（インラインリンク等の例外を除く）",
    axeTags: ["wcag258"],
  },
  ...
  },
  {
    ...
    category: "理解可能",
    level: "AA",
    description: "ページの主言語と異なる言語の部分にlang属性が設定されているか",
    axeTags: ["wcag312"],
  },
  {
    id: "3.2.1",
  ...
  },
  {
    ...
    category: "理解可能",
    level: "A",
    description: "フォーム要素の値を変更しただけで予期しないコンテキストの変化が起きないか",
    axeTags: ["wcag322"],
  },
  {
    id: "3.2.3",
    ...
    category: "理解可能",
    level: "AA",
    description: "複数ページ間でナビゲーションの順序と構成が一貫しているか",
    axeTags: ["wcag323"],
  },
  {
    id: "3.2.4",
  ...
  },
  {
    ...
    category: "理解可能",
    level: "A",
    description: "ヘルプ手段（連絡先、チャットbot等）が複数ページ間で一貫した相対的な位置にあるか",
    axeTags: ["wcag326"],
  },
  {
    id: "3.3.1",
    ...
    category: "理解可能",
    level: "A",
    description: "入力エラーが自動検出された場合、エラー箇所と内容がテキストで説明されているか",
    axeTags: ["wcag331"],
  },
  {
    id: "3.3.2",
    ...
    category: "理解可能",
    level: "A",
    description: "フォーム要素にラベルまたは入力説明があるか。label要素の紐付けと説明の適切さ",
    axeTags: ["wcag332"],
  },
  {
    id: "3.3.3",
    ...
    category: "理解可能",
    level: "AA",
    description: "入力エラーが検出された場合、修正方法の提案が提示されるか",
    axeTags: ["wcag333"],
  },
  {
    id: "3.3.4",
    ...
    category: "理解可能",
    level: "AA",
    description: "法的/金融的な取引やデータ送信の前に、確認・修正・取消が可能か",
    axeTags: ["wcag334"],
  },
  ...
  // --- 4. 堅牢 (Robust) ---
  {
    ...
    category: "堅牢",
    level: "A",
    description: "カスタムUIコンポーネントに適切なrole、name、stateがARIAで設定されているか",
    axeTags: ["wcag412"],
  },
  {
    id: "4.1.3",
...
function evaluateCriterion(criterion: WcagCriterion, data: AxeResult): CriterionResult {
  const matchesTags = (rule: AxeRule) => criterion.axeTags.some((tag) => rule.tags.includes(tag))
...
function mergeResults(
  ...
  if (interactiveData) {
    const check = interactiveData.results.find((r) => r.criterion === criterion.id)
...
function _deriveLabel(url: string): string {
  try {
  ...
  switch (status) {
    case "適合":
      return {
        type: "pattern",
        pattern: "solid",
        fgColor: { argb: COLORS.pass },
      }
    case "不適合":
      return {
        type: "pattern",
        pattern: "solid",
        fgColor: { argb: COLORS.fail },
      }
    case "要確認":
      return {
        type: "pattern",
        pattern: "solid",
        fgColor: { argb: COLORS.incomplete },
      }
    case "目視確認":
      return {
        type: "pattern",
        pattern: "solid",
        fgColor: { argb: COLORS.manual },
      }
  }
}
...
function populateSummarySheet(
  ...
  headerRow.eachCell((cell) => {
    cell.fill = {
      type: "pattern",
      pattern: "solid",
      fgColor: { argb: COLORS.summaryHeaderBg },
    }
    cell.font = { bold: true, color: { argb: COLORS.headerFont } }
    cell.alignment = {
      vertical: "middle",
...
async function generateMultiUrlExcel(manifest: Manifest, outputPath: string): Promise<void> {
  ...
  const _manifestDir = dirname(resolve(outputPath, ".."))
  ...
  for (const entry of manifest.entries) {
    ...
    const visualData =
      entry.visualJson && existsSync(entry.visualJson)
    ...
    const mergedResult = buildMergedResult(
      entry.url,
      dateStr,
      axeData,
      visualData,
...
async function generateSingleUrlExcel(
  ...
  console.log(
    `  - 確認OK: ${summary.passCount} / 修正あり: ${summary.failCount} / 未確認: ${summary.unknownCount}`,
  )
}
...
if (args.manifestPath) {
  ...
  const visualData =
    args.visualJsonPath && existsSync(args.visualJsonPath)
      ? loadJson<VisualTestOutput>(args.visualJsonPath)
      : undefined

  const interactiveData =
    args.interactiveJsonPath && existsSync(args.interactiveJsonPath)
